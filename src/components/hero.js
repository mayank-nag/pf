...
export function renderHero() {
  ...
  section.innerHTML = `
    ...
    <div class="social-icons" id="socialIcons">
      <a href="mailto:${profile.email}" class="light-icon" title="Email">@</a>
      <a href="${profile.social.github}" target="_blank" class="light-icon" title="GitHub">
        ${githubSVG}
      </a>
      <a href="${profile.social.linkedin}" target="_blank" class="light-icon" title="LinkedIn">
        ${linkedinSVG}
      </a>
    </div>

    <div class="hero-content" id="heroContent">
      <div class="hero-intro" id="heroTagline">— Portfolio</div>
      <h1 class="hero-name" id="heroName">
        <span class="line"><span class="dark-text" id="heroLine1">${profile.name.first}</span></span>
        <span class="line"><span class="light-text" id="heroLine2">${profile.name.last}</span></span>
      </h1>
